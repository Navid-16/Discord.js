        ...
        db.query(sql0, function (err, rows) {
            ...
            if (!rows.length) {
                ...
                try {
                    ...
                    message.channel.send({ embeds: [registered] });
                } catch (err) {
                    console.log(err)
                }
            } else {
                if (allanswers[answers] === win1) {
                    ...
                    db.query(sql, function (err) {
                        ...
                        message.channel.send({ embeds: [win] }).then(message => {
                            ...
                            function time() {
                                ...
                                message.edit({ embeds: [editedeembed] }).then(message => {
                                    ...
                                    function time2() {
                                        const pointsembed = new Discord.MessageEmbed()
                                            ...
                                            .setTimestamp()
                                            .addFields(
                                                { name: `${user.username} won`, value: points.toString() },
                                                { name: `TOTAL POINTS`, value: totalpoints.toString() }
                                            )
                                            .setAuthor(user.username, user.displayAvatarURL())

                                        message.edit({ embeds: [pointsembed] });
                                    }
                                });
                            }
                        })
                                ...
                                message.edit({ embeds: [editedeembed] }).then(message => {
                                    ...
                                    function time2() {
                                        const pointsembed = new Discord.MessageEmbed()
                                            ...
                                            .setTimestamp()
                                            .addFields(
                                                { name: `${user.username.toString()} won`, value: points.toString() },
                                                { name: `TOTAL POINTS`, value: totalpoints.toString() }
                                            )
                                            .setAuthor(user.username, user.displayAvatarURL())
                            ...
                            function time() {
                                ...
                                message.edit({ embeds: [editedeembed] }).then(message => {
                                    ...
                                    function time2() {
                                        ...
                                        message.edit({ embes: [pointsembed] });
                                    }
                                });
                            }
                        })
                    ...
                    db.query(sql, function (err) {
                        ...
                        message.channel.send({ embeds: [lose] }).then(message => {
                            setTimeout(time, 3000)
                            function time() {
                                const editedeembed = new Discord.MessageEmbed()
                                ...
                                message.edit({ embeds: [editedeembed] }).then(message => {
                                    ...
                                    function time2() {
                                        const pointsembed = new Discord.MessageEmbed()
                                            ...
                                            .setTimestamp()
                                            .addFields(
                                                { name: `${user.username} lost`, value: points.toString() },
                                                { name: `TOTAL POINTS`, value: totalpoints.toString() }
                                            )
                                            .setAuthor(user.username, user.displayAvatarURL())
